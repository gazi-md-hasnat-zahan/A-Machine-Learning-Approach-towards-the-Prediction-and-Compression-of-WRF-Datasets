...
for train, test in kf.split(X_train,Y_train):
  # create model
    model=Sequential()
    model.add(Dense(units=2, input_dim=2, activation= "relu",name='layer_in'))
...
plt.xlabel('Model')
plt.show()
plt.savefig('CVPlot_Loss-NNModel_v3_basic.png')
...
plt.xlabel('Model')
plt.show()
plt.savefig('CVPlot_MAE-NNModel_v3_basic.png')
...
#saving model
model.save("model_latest_V3-basic.h5")
...
plt.show()
plt.savefig('NNModel_V3_basic_MAE_Plot.png')
...
plt.legend(['Training', 'Validation'], loc='upper right')
plt.show()
plt.savefig('NnModel_V3_basic_Loss_Plot.png')
